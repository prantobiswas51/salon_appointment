            ...
            <div className="p-2 m-4">
                ...
                <div className="block lg:hidden space-y-4">
                    {clients.data.map((client) => (
                        <div
                            key={client.id}
                            className="bg-white shadow-md rounded-md p-4 border space-y-2"
                        >
                            ...
                            <p className="text-gray-600 text-sm">Status: {client.status}</p>
                ...
                {isModalOpen && editingClient && (
                    <div className="fixed inset-0 bg-gray-700/40 flex justify-center items-center p-4 z-50">
                        <div className="bg-sky-100 w-full max-w-md p-6 rounded-md shadow-lg">
